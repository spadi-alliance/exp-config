...
endpoint     STFBuilder              dqm           type push method bind  enable-uds false portRangeMin 22000 portRangeMax 23000
...
endpoint     LogicFilter             out	   type push method connect autoSubChannel true enable-uds true
# endpoint     LogicFilter             dqm	   type pub  method bind    autoSubChannel false
...
link    TimeFrameSlicerByLogicTiming  out            FileSink          in         
link    STFBuilder              dqm                  Scaler            in
#link    Scaler                  out                  ScrSink           in
