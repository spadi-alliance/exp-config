...
# LR-TDC or NIKUMARI
${AMANEQ_SOFT_DIR}/StrLRTDC/bin/set_tdcmask 192.168.2.101       0x00000000 0x00000000 0x00000000 0x000000000 0x0

# HR-TDC
${AMANEQ_SOFT_DIR}/StrHRTDC/bin/set_tdcmask 192.168.2.103 both  0xffff0000 0xffffffff
${AMANEQ_SOFT_DIR}/StrHRTDC/bin/set_tdcmask 192.168.2.102 both  0x00000000 0x00000000
${AMANEQ_SOFT_DIR}/StrHRTDC/bin/set_tdcmask 192.168.2.104 both  0x00000000 0x00000000
${AMANEQ_SOFT_DIR}/StrHRTDC/bin/set_tdcmask 192.168.2.105 both  0x00000000 0x00000000
${AMANEQ_SOFT_DIR}/StrHRTDC/bin/set_tdcmask 192.168.2.106 both  0x00000000 0x00000000
