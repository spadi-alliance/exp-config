...
param  AmQStrTdcSampler-1         msiTcpIp   192.168.2.102   TdcType     7
param  AmQStrTdcSampler-2         msiTcpIp   192.168.2.103   TdcType     5
...
param FileSink-4  multipart true prefix  data/tdcdata/04 ext .dat
param FileSink-5  multipart true prefix  data/tdcdata/05 ext .dat
#
# Sink for Decimator         
...
param DecSink-4  multipart true prefix data/dcmdata/04 ext .dat
param DecSink-5  multipart true prefix data/dcmdata/05 ext .dat
