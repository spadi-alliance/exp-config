...
do
    ...
    tmux new-window -d -n TimeFrameSlicer${runID} -t tfs -- ./start_device.sh TimeFrameSlicerByLogicTiming #--host-ip 192.168.2.52
    sleep 0.2
done
tmux kill-window -t tfs:0
xterm -geometry 80x15+0+440 -T TimeFrameSlicer -e tmux a -t tfs &
