...
DAQSERVICE_URI=' --registry-uri tcp://192.168.2.109:6379/0'
METRICS_URI=' --metrics-uri tcp://192.168.2.109:6379/1'
CONFIG_URI=' --parameter-config-uri tcp://192.168.2.109:6379/2'

#---------------------------------------------------------
if [[ $1 =~ fairmq- ]]; then
  BINDIR=""
else
  BINDIR=/home/nestdaq/work/nestdaq-impl.install/bin
