...
# DQM
#endpoint     AmQStrTdcDqm            in            type pull method bind    portRangeMin 22001 portRangeMax 22999  rateLogging 5
#endpoint     AmQStrTdcDqm            in            type pub method bind    portRangeMin 22001 portRangeMax 22999  rateLogging 5 
...
#link    STFBuilder              dqm                  AmQStrTdcDqm     in
